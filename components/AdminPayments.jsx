...
export default function AdminPayments({ tenants, invoices = [] }) {
  ...
  const allMonths = [...new Set(invoices.map(inv => inv.month))];
        ...
        <>
          <div style={{ display: "grid", gap: 12, marginBottom: 24 }}>
            ...
            <div style={{ background: "#fef2f2", borderRadius: 14, padding: "20px", border: "1px solid #fca5a5" }}>
              <div style={{ fontSize: 11, fontWeight: 700, color: "#9ca3af", textTransform: "uppercase", marginBottom: 8 }}>Outstanding Balance (All Months)</div>
          ...
          <div style={{ background: "#fff", borderRadius: 14, border: "1px solid rgba(0,0,0,0.07)", overflow: "hidden" }}>
            ...
            {monthInvoices.length === 0 ? (
              <div style={{ padding: 40, textAlign: "center", color: "#9ca3af" }}>No invoices for this month yet</div>
                  ...
                  <div style={{ textAlign: "right" }}>
                    ...
                    {lateFee > 0 && (
                      <div style={{ fontSize: 11, color: "#dc2626" }}>
                        $35 base + ${daysLate * 10} ({daysLate} days × $10) = ${lateFee} late fees
                      </div>
                    )}
                  </div>
