...
export default function App() {
  ...
  const updateTenants = async (newTenants) => {
    ...
    // Find changed tenant and save to Supabase
    for (const t of newTenants) {
      await supabase.from("tenants").upsert({
        ...
        amount_owed: t.amountOwed || t.amount_owed || 0,
        override_late: t.overrideLate ?? t.override_late ?? null,
        section8: t.section8 || false,
        section8_amount: t.section8Amount || t.section8_amount || 0,
        tenant_portion: t.tenantPortion || t.tenant_portion || 0,
        housing_owed_back: t.housingOwedBack || t.housing_owed_back || 0,
