...
export default function AdminDashboard({ onLogout, sharedTenants, setSharedTenants, sharedTickets, setSharedTickets }) {
  ...
  // Keep shared state in sync with admin changes
  ...
  return (
    <div style={{ fontFamily: "'DM Sans', sans-serif", background: "#0f1a14", minHeight: "100vh", display: "flex" }}>
      ...
      <div style={{ flex: 1, overflowY: "auto", background: "#f5f7f5" }}>
        ...
        {active === "tickets" && <AdminTickets tenants={tenants} sharedTickets={sharedTickets} setSharedTickets={setSharedTickets} />}
        ...
        {active === "messages" && <AdminMessages tenants={tenants} />}
